...
2. READ its entire contents - this is the CORE OS for EXECUTING the specific workflow-config @.anyon/anyon-method/workflows/3-solutioning/create-epics-and-stories/workflow.yaml
3. Pass the yaml path .anyon/anyon-method/workflows/3-solutioning/create-epics-and-stories/workflow.yaml as 'workflow-config' parameter to the workflow.xml instructions
