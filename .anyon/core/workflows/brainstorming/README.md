...
The workflow leverages configuration from `.anyon/core/config.yaml`:
...
- Access to the CIS module configuration (`.anyon/cis/config.yaml`)
...
- Follow ANYON documentation standards for workflow customization

---

_Part of the Anyon Method v6 - Creative Ideation and Synthesis (CIS) Module_
