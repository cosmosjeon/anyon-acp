...
<critical>You MUST have already loaded and processed: {project_root}/.anyon/core/workflows/brainstorming/workflow.yaml</critical>
...
<invoke-task halt="true">{project-root}/.anyon/core/tasks/advanced-elicitation.xml</invoke-task>
