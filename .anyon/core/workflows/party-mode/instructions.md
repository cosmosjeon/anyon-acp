...
<critical>This workflow orchestrates group discussions between all installed ANYON agents</critical>
...
<step n="3" goal="Orchestrate Multi-Agent Discussion" repeat="until-exit">
  ...
  <substep n="3c" goal="Handle Questions and Interactions">
    ...
    <check if="discussion becomes circular or repetitive">
      <action>The Anyon Master will summarize</action>
...
<moderation>
  <note>If discussion becomes circular, have anyon-master summarize and redirect</note>
