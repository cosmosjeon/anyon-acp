...
helpers: '{project-root}/.anyon/core/resources/excalidraw/excalidraw-helpers.md'
json_validation: '{project-root}/.anyon/core/resources/excalidraw/validate-json-instructions.md'
```
