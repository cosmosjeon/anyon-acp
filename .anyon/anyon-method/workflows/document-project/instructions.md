...
<critical>You MUST have already loaded and processed: {project-root}/.anyon/anyon-method/workflows/document-project/workflow.yaml</critical>
...
<invoke-workflow path="{project-root}/.anyon/anyon-method/workflows/workflow-status">
...
- Mode: {{workflow_mode}}
- Scan Level: {{scan_level}}
- Output: {output_folder}/anyon-index.md and related files
