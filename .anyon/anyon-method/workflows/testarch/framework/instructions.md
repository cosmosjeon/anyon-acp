...
**Workflow ID**: `.anyon/anyon-method/testarch/framework`
...
**Critical:** Consult `{project-root}/.anyon/anyon-method/testarch/tea-index.csv` to identify and load relevant knowledge fragments:
