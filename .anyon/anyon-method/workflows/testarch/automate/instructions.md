<!-- Powered by ANYON-CORE™ -->

# Test Automation Expansion

**Workflow ID**: `.anyon/anyon-method/testarch/automate`
**Version**: 4.0 (Anyon v6)
...
1. **Anyon-Integrated Mode**: Works WITH Anyon artifacts (story, tech-spec, PRD, test-design) to expand coverage after story implementation
2. **Standalone Mode**: Works WITHOUT Anyon artifacts - analyzes existing codebase and generates tests independently
...
### Optional (Anyon-Integrated Mode)
...
**If framework is missing:** HALT with message: "Framework scaffolding required. Run `anyon tea *framework` first."
...
1. **Detect Execution Mode**
   ...
   Check if Anyon artifacts are available:
   - If `{story_file}` variable is set → Anyon-Integrated Mode
...
2. **Load Anyon Artifacts (If Available)**

   **Anyon-Integrated Mode:**
...
5. **Load Knowledge Base Fragments**
   ...
   **Critical:** Consult `{project-root}/.anyon/anyon-method/testarch/tea-index.csv` to load:
...
1. **Determine What Needs Testing**
   ...
   **Anyon-Integrated Mode (story available):**
...
1. **Create Automation Summary Document**
   ...
   **Coverage Status:**
   ...
   3. Integrate with quality gate: `anyon tea *gate`
   ...
   **Coverage Gaps Identified:**
   ...
   {Same structure as Anyon-Integrated Mode}
   ...
   {Same checklist as Anyon-Integrated Mode}
   ````
...
- Works with any project (Anyon or non-Anyon)
...
**Mode:** {standalone_mode ? "Standalone" : "Anyon-Integrated"}
...
4. Integrate with quality gate: `anyon tea *gate`
...
- [ ] Execution mode determined (Anyon-Integrated, Standalone, or Auto-discover)
- [ ] Anyon artifacts loaded if available (story, tech-spec, test-design, PRD)
