...
**Note:** Anyon artifacts (story, tech-spec, PRD) are OPTIONAL - workflow can run without them
...
- [ ] **Note**: Absence of Anyon artifacts does NOT halt workflow
...
**Anyon-Integrated Mode (if story available):**
...
- [ ] Document includes execution mode (Anyon-Integrated, Standalone, Auto-discover)
...
### With Anyon Workflows (If Available - OPTIONAL)
...
### Issue: Anyon artifacts not found

**Problem:** Story, tech-spec, or PRD files not found when variables are set.

**Resolution:**

- **automate does NOT require Anyon artifacts** - they are OPTIONAL enhancements
- If files not found, switch to Standalone Mode automatically
- Analyze source code directly without Anyon context
...
- Message: "Framework scaffolding required. Run `anyon tea *framework` first."
...
- **automate is flexible:** Can work with or without Anyon artifacts (story, tech-spec, PRD are OPTIONAL)
