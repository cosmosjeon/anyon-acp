...
- [ ] Story file is accessible (if using Anyon mode)
...
- [ ] Gate decision appended to anyon-workflow-status.md (if append_to_history: true)
...
### Anyon Workflow Status

- [ ] Gate decision added to `anyon-workflow-status.md`
