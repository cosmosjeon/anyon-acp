...
- Mark story as IN PROGRESS in `anyon-workflow-status.md`
...
7. **When refactoring complete**, run `anyon sm story-done` to move story to DONE
...
- Refer to `./anyon-method/docs/tea-README.md` for workflow documentation
- Consult `./anyon-method/testarch/knowledge` for testing best practices

---

**Generated by Anyon TEA Agent** - {date}
