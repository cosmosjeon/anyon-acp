...
<workflow>
  ...
  <step n="1" goal="Validate workflow readiness" tag="workflow-status">
    ...
    <check if="status file found">
      <action>Load the FULL file: {output_folder}/anyon-workflow-status.yaml</action>
  ...
  <step n="4" goal="Update status and complete" tag="workflow-status">
    <check if="standalone_mode != true">
      ...
      <action>Update workflow_status["brainstorm-project"] = "{output_folder}/anyon-brainstorming-session-{{date}}.md"</action>
...
- Brainstorming results saved to: {output_folder}/anyon-brainstorming-session-{{date}}.md
