...
<check if="standalone_mode != true">
  ...
  <action>Update workflow_status["research"] = "{output_folder}/anyon-research-{{research_mode}}-{{date}}.md"</action>
...
- Research report generated and saved to {output_folder}/anyon-research-{{research_mode}}-{{date}}.md
