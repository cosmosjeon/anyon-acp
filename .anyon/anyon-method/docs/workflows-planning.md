...
graph TB
    ...
    subgraph AnyonMethod["<b>ANYON METHOD (Recommended)</b>"]
        direction TB
    ...
    subgraph Enterprise["<b>ENTERPRISE METHOD</b>"]
        direction TB
        EntNote["<b>Uses Anyon Method Planning</b><br/>+<br/>Extended Phase 3 workflows<br/>(Architecture + Security + DevOps)<br/>30+ stories typically"]
    end
    ...
    Enterprise -.->|Uses Anyon planning| Architecture
    ...
    style AnyonMethod fill:#e1bee7,stroke:#6a1b9a,stroke-width:3px,color:#000
...
| **prd**                      | PM            | Anyon Method | Strategic PRD with FRs/NFRs (no epic breakdown)           | 10-50+          |
| **gdd**                      | Game Designer | Anyon Method | Game Design Document with requirements                    | 10-50+          |
| **narrative**                | Game Designer | Anyon Method | Story-driven game/experience design                       | 10-50+          |
| **create-ux-design**         | UX Designer   | Anyon Method | Optional UX specification (after PRD)                     | N/A             |
| **create-epics-and-stories** | PM            | Anyon Method | Break requirements into Epic+Stories (AFTER architecture) | N/A             |
...
### Track 2: Anyon Method (RECOMMENDED)
...
**Planning (Phase 2):** Uses Anyon Method planning (PRD with FRs/NFRs)
...
**Purpose:** Strategic PRD with Functional Requirements (FRs) and Non-Functional Requirements (NFRs) for software products (Anyon Method track).
...
**Purpose:** Complete game design document for game projects (Anyon Method track).
...
**Purpose:** Story-driven design workflow for games/experiences where narrative is central (Anyon Method track).
...
**Purpose:** UX specification for projects where user experience is the primary differentiator (Anyon Method track).
...
**Purpose:** Break requirements into bite-sized stories organized in epics (Anyon Method track).
...
- **Software product** → `prd` (Anyon Method)
- **Game (gameplay-first)** → `gdd` (Anyon Method)
- **Game (story-first)** → `narrative` + `gdd` (Anyon Method)
- **UX innovation project** → `ux` + `prd` (Anyon Method)
...
| PRD.md              | **architecture** (Level 3-4)         | Anyon Method (recommended)    |
| GDD.md              | **architecture** (game tech)         | Anyon Method (recommended)    |
| narrative-design.md | **architecture** (narrative systems) | Anyon Method                  |
| ux-spec.md          | **architecture** (frontend design)   | Anyon Method                  |
...
- **Anyon Method:** Optional Phase 3 (simple), Required Phase 3 (complex)
...
If `workflow-init` suggests Anyon Method, there's likely complexity you haven't considered. Review carefully before overriding.
...
### Greenfield Software (Anyon Method)
...
### Brownfield Software (Anyon Method)
...
A: No. Simple changes use `tech-spec` (Quick Flow). Only Anyon Method and Enterprise tracks create PRDs.

**Q: Can I skip Phase 3 (Solutioning)?**
A: Yes for Quick Flow. Optional for Anyon Method (simple projects). Required for Anyon Method (complex projects) and Enterprise.
