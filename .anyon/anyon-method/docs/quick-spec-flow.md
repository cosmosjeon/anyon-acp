...
Quick Spec Flow is a **streamlined alternative** to the full Anyon Method for Quick Flow track projects. Instead of going through Product Brief → PRD → Architecture, you go **straight to a context-aware technical specification** and start coding.
...
❌ **Use Anyon Method or Enterprise tracks when:**
...
| Aspect                | Quick Flow Track             | Anyon Method/Enterprise Tracks      |
| --------------------- | ---------------------------- | ---------------------------------- |
...
## When to Graduate from Quick Flow to Anyon Method

Start with Quick Flow, but switch to Anyon Method when:
...
💡 **Tip:** You can always run `workflow-init` later to transition from Quick Flow to Anyon Method!
...
- Anyon Method installed (`npx anyon-method install`)
...
**A:** No problem! You can always transition to Anyon Method by running workflow-init and create-prd. Your tech-spec becomes input for the PRD.
