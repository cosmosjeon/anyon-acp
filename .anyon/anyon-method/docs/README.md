...
Complete guides for the Anyon Method Module (BMM) - AI-powered agile development workflows that adapt to your project's complexity.
...
**[Complete Workflow Diagram](./images/workflow-method-greenfield.svg)** - Visual flowchart showing all phases, agents (color-coded), and decision points for the Anyon Method standard greenfield track.
...
- **[Scale Adaptive System](./scale-adaptive-system.md)** - How BMM adapts to project size and complexity (42 min read)
  - Three planning tracks (Quick Flow, Anyon Method, Enterprise Method)
...
- **[Agents Guide](./agents-guide.md)** - Comprehensive agent reference (45 min read)
  - 12 specialized ANYON Method agents + Anyon Master
...
- **[Phase 2: Planning Workflows](./workflows-planning.md)** - Scale-adaptive planning (967 lines)
  ...
  - Track-based planning approach (Quick Flow, Anyon Method, Enterprise Method)
...
- **[Phase 3: Solutioning Workflows](./workflows-solutioning.md)** - Architecture and validation (638 lines)
  ...
  - Required for Anyon Method and Enterprise Method tracks
...
- **[Testing & QA Workflows](./test-architecture.md)** - Comprehensive quality assurance (1,420 lines)
  ...
  - Anyon-integrated vs standalone modes
...
- **[GitHub Issues](https://github.com/anyon-code-org/ANYON-METHOD/issues)** - Report bugs or request features
- **[YouTube Channel](https://www.youtube.com/@AnyonCode)** - Video tutorials and walkthroughs
