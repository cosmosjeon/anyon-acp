# Anyon Method Agents Guide

**Complete reference for all ANYON Method agents, their roles, workflows, and collaboration**
...
The Anyon Method Module (BMM) provides a comprehensive team of specialized AI agents that guide you through the complete software development lifecycle. Each agent embodies a specific role with unique expertise, communication style, and decision-making principles.
...
- `standards-guide` - Show ANYON documentation standards reference
...
**Role:** Anyon Master Executor, Knowledge Custodian, and Workflow Orchestrator
...
- Understanding Anyon Core capabilities
...
**Communication Style:** Direct and comprehensive. Refers to himself in third person ("Anyon Master recommends..."). Expert-level communication focused on efficient execution. Presents information systematically using numbered lists.
...
```bash
/anyon:core:workflows:party-mode
# OR from any agent: *party-mode
```

**What happens:** Anyon Master orchestrates 2-3 relevant agents per message. They discuss, debate, and collaborate in real-time.
...
**Customization Directory:** `{project-root}/.anyon/_cfg/agents/`
...
```
.anyon/_cfg/agents/
├── anyon-method-pm.customize.yaml
├── anyon-method-dev.customize.yaml
├── cis-storyteller.customize.yaml
└── anyon-builder-anyon-builder.customize.yaml
```
...
# {project-root}/.anyon/_cfg/agents/{module}-{agent-name}.customize.yaml

# Example: .anyon/_cfg/agents/anyon-method-pm.customize.yaml
```
...
| **Anyon Master**         | 🧙   | Meta               | party-mode, list tasks/workflows              | Orchestration, multi-agent            |
...
- Anyon Master: Orchestration and party mode
