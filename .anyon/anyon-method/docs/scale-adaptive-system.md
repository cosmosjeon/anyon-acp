# Anyon Method Scale Adaptive System
...
Anyon Method adapts to three distinct planning tracks:

- **Quick Flow**: Tech-spec only, implement immediately
- **Anyon Method**: PRD + Architecture, structured approach
...
| **Anyon Method**       | PRD + Arch + UX       | 1-3 days        | Products, platforms, complex features      |
...
flowchart TD
    ...
    START -->|Product, platform, complex| M[Anyon Method<br/>PRD + Architecture]
...
- **Anyon Method**: product, platform, dashboard, complex, multiple features
...
```
workflow-init: "Based on 'Add user dashboard with analytics', I recommend Anyon Method.
...
_Detailed flowchart showing all phases, workflows, agents (color-coded), and decision points for the Anyon Method track. Each colored box represents a different agent role._
...
Includes all Anyon Method documents PLUS:
...
| **Anyon Method** | Recommended | PRD + UX  | Required     | None         | 10-50+          |
...
### Scenario 3: Customer Portal (Anyon Method)
...
### Scenario 4: E-commerce Platform (Anyon Method)
...
If `workflow-init` suggests Anyon Method, there's probably complexity you haven't considered. Review carefully before overriding.
...
For Anyon Method and Enterprise, implementation readiness checks prevent costly mistakes. Invest the time.

### 5. Architecture is Optional but Recommended for Brownfield

Brownfield Anyon Method makes architecture optional, but it's highly recommended. It distills complex codebase into focused solution design.
...
Product Brief is only offered for greenfield Anyon Method and Enterprise. It's optional but helps with strategic thinking.
...
- Clear track purposes:
  ...
  - Anyon Method = Product + system design
