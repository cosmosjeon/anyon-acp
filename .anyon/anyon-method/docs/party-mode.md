...
Type `/anyon:core:workflows:party-mode` (or `*party-mode` from any agent), and suddenly you've got **all your AI agents** in one conversation. PM, Architect, DEV, UX Designer, the CIS creative agents - everyone shows up.
...
1. Party mode reads `.anyon/_cfg/agent-manifest.csv`
2. Loads ALL installed agents (already includes your customizations from install)
3. Anyon Master orchestrates - picks 2-3 relevant agents per message based on topic
...
Party mode uses agents from `.anyon/[module]/agents/*.md` - these already include any customizations you applied during install.

**To customize agents for party mode:**

1. Create customization file: `.anyon/_cfg/agents/anyon-method-pm.customize.yaml`
2. Run `npx anyon-method install` to rebuild agents
...
**BMB (1 agent):** Anyon Builder

**Core (1 agent):** Anyon Master (orchestrator)
...
Anyon Master will summarize and redirect, or you can make a decision and move on.

**Too many agents talking?**
Make your topic more specific - Anyon Master picks 2-3 agents based on relevance.

**Agents not using customizations?**
Make sure you ran `npx anyon-method install` after creating customization files.
