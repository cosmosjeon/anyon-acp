...
Quick answers to common questions about the Anyon Method Module.
...
1. Install Anyon Method: `npx anyon-method@alpha install`
...
**A:** Check your `anyon-workflow-status.md` file (created by workflow-init). It shows your current phase and progress. If you don't have this file, you can also tell by what you're working on:
...
See [IDE Setup Guides](https://github.com/anyon-code-org/ANYON-METHOD/tree/main/docs/ide-info) for configuration specifics.

### Q: Can I customize agents?

**A:** Yes! Agents are installed as markdown files with XML-style content (optimized for LLMs, readable by any model). Create customization files in `.anyon/_cfg/agents/[agent-name].customize.yaml` to override default behaviors while keeping core functionality intact. See agent documentation for customization options.
...
1. Run `/anyon:core:workflows:party-mode` (or `*party-mode` from any agent)
2. Introduce your topic
3. Anyon Master selects 2-3 most relevant agents per message
...
3. Open a [GitHub Issue](https://github.com/anyon-code-org/ANYON-METHOD/issues)
4. Watch [YouTube Tutorials](https://www.youtube.com/@AnyonCode)

### Q: How do I report a bug or request a feature?

**A:** Open a GitHub issue at: https://github.com/anyon-code-org/ANYON-METHOD/issues
...
**Have a question not answered here?** Please [open an issue](https://github.com/anyon-code-org/ANYON-METHOD/issues) or ask in [Discord](https://discord.gg/gk8jAdXWmj) so we can add it!
