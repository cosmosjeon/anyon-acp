...
**Required for:** Anyon Method (complex projects), Enterprise Method

**Optional for:** Anyon Method (simple projects), Quick Flow (skip entirely)
...
graph TB
    ...
    subgraph AnyonEnterprise["<b>ANYON METHOD + ENTERPRISE (Same Start)</b>"]
        direction TB
    ...
    FromPlanning -->|Anyon Method<br/>or Enterprise| OptionalUX
    ...
    style AnyonEnterprise fill:#90caf9,stroke:#0d47a1,stroke-width:3px,color:#000
...
| ---------------------------- | ----------- | ------------------------ | -------------------------------------------- |
| **create-ux-design**         | UX Designer | Anyon Method, Enterprise  | Optional UX design (after PRD, before arch)  |
| **architecture**             | Architect   | Anyon Method, Enterprise  | Technical architecture and design decisions  |
| **create-epics-and-stories** | PM          | Anyon Method, Enterprise  | Break FRs/NFRs into epics after architecture |
| **implementation-readiness** | Architect   | Anyon Complex, Enterprise | Validate planning/solutioning completeness   |
...
- **Anyon Method:** Multi-epic projects need architecture to prevent conflicts
- **Enterprise:** Same as Anyon Method, plus optional extended workflows (test architecture, security architecture, devops strategy) added AFTER architecture but BEFORE gate check
...
- Multi-epic projects (Anyon Complex, Enterprise)
...
- Anyon Method Simple with straightforward tech stack
...
- **Always** before Phase 4 for Anyon Complex and Enterprise projects
...
- Anyon Simple (no gate check required)
...
**Note:** Enterprise uses the same planning and architecture as Anyon Method. The only difference is optional extended workflows added AFTER architecture but BEFORE create-epics-and-stories.
...
Don't over-architect simple projects. Anyon Simple projects need simple architecture.
...
- **Planning:** prd (PM) - creates FRs/NFRs only (same as Anyon Method)
...
**Key Difference:** Enterprise adds optional extended workflows AFTER architecture but BEFORE create-epics-and-stories. Everything else is identical to Anyon Method.
...
- Use architecture for Anyon Method and Enterprise (both required)
...
A: No. Quick Flow skips it. Anyon Method and Enterprise both require it.

**Q: How do I know if I need architecture?**
A: If you chose Anyon Method or Enterprise track in planning (workflow-init), you need architecture to prevent agent conflicts.
...
A: Only for Quick Flow. Anyon Method and Enterprise both require gate check before Phase 4.
...
A: Anyon Method: 1-2 days for architecture. Enterprise: 2-3 days total (1-2 days architecture + 0.5-1 day optional extended workflows). If taking longer, you may be over-documenting.
