...
- [ ] All paths in web_bundle use .anyon/-relative format (NOT {project-root})
...
- [ ] existing_workflows maps workflow variables to .anyon/-relative paths correctly
...
**Auditor:** Audit Workflow (ANYON v6)
