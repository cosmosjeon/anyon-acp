...
Use this checklist to validate module edits meet ANYON Core standards.

## Module Structure Validation

- [ ] Module has clear 3-letter code (anyon-method, anyon-builder, cis, etc.)
- [ ] Module is in correct location (src/modules/ for source, .anyon/ for installed)
- [ ] agents/ directory exists
- [ ] workflows/ directory exists
- [ ] config.yaml exists in module root
- [ ] README.md exists in module root
- [ ] Directory structure follows ANYON conventions
...
- [ ] README explains module's role in ANYON ecosystem
...
- [ ] Paths are .anyon/-relative (not project-root)
