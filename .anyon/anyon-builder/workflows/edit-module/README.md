...
Interactive workflow for editing existing ANYON modules, including structure, agents, workflows, configuration, and documentation.

## Purpose

This workflow helps you improve and maintain ANYON modules by:
...
```yaml
# In agent menu item:
workflow: '{project-root}/.anyon/other-module/workflows/shared-workflow/workflow.yaml'
```
