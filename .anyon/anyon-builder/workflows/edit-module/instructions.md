...
<critical>You MUST have already loaded and processed: {project-root}/.anyon/anyon-builder/workflows/edit-module/workflow.yaml</critical>
...
<ask>What is the path to the module you want to edit? (provide path to module directory like .anyon/anyon-method/ or src/modules/anyon-method/)</ask>
...
- Understand ANYON module patterns and conventions
  </action>

<action>Analyze the module deeply:

- Identify module purpose and role in ANYON ecosystem
...
2. **Propose improvements with rationale**
   ...
   - Provide examples from reference modules: {anyon_method_module_dir}, {anyon_builder_module_dir}, {cis_module_dir}
...
- Show how to reference workflows properly: {project-root}/.anyon/{{module}}/workflows/{{workflow}}/workflow.yaml
...
- "The ANYON convention is to {{pattern}} which helps with {{benefit}}"

Connect improvements to broader ANYON principles without being preachy.
</action>
...
If this is part of larger ANYON work:
