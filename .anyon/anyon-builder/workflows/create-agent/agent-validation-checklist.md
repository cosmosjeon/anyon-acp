# ANYON Agent Validation Checklist

Use this checklist to validate agents meet ANYON quality standards, whether creating new agents or editing existing ones.

## YAML Structure Validation (Source Files)

- [ ] YAML parses without errors
- [ ] `agent.metadata` includes: `id`, `name`, `title`, `icon`
- [ ] `agent.metadata.module` present if Module agent (e.g., `anyon-method`, `bmgd`, `cis`)
...
- [ ] Compare against reference agents (commit-poet, journal-keeper, ANYON Method agents) - similar quality?
...
✓ Comparable quality to reference agents (commit-poet, journal-keeper, ANYON Method agents)
