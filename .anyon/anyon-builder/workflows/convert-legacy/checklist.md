...
- [ ] ALL paths reference {project-root}/.anyon/{{module}}/ locations, NOT src/
- [ ] exec, data, run-workflow commands point to final ANYON installation paths
...
- [ ] Elicitation points (elicit: true) converted to <invoke-task halt="true">{project-root}/.anyon/core/tasks/advanced-elicitation.xml</invoke-task>
