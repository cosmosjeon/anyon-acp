...
An intelligent workflow editor that helps you modify existing ANYON workflows while adhering to all best practices and conventions documented in the workflow creation guide.
...
- Ensure compliance with ANYON workflow conventions
...
4. **Best Practices**: Ensures all edits follow ANYON conventions
...
- Understanding of ANYON workflow types
