...
<critical>You MUST have already loaded and processed: {project-root}/.anyon/anyon-builder/workflows/edit-workflow/workflow.yaml</critical>
...
- Verify paths are .anyon/-relative
