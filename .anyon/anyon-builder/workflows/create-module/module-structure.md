# ANYON Module Structure Guide

## What is a Module?

A ANYON module is a self-contained package of agents, workflows, tasks, and resources that work together to provide specialized functionality. Think of it as an expansion pack for the ANYON Method.
...
```
# SOURCE MODULE (in ANYON-METHOD project)
...
{project-root}/.anyon/{module-code}/
...
menu:
  - trigger: command-name
    workflow: '{project-root}/.anyon/SOURCE_MODULE/workflows/path/workflow.yaml'
    workflow-install: '{project-root}/.anyon/THIS_MODULE/workflows/vendored/workflow.yaml'
...
data_path:
  result: '{project-root}/.anyon/module-code/data'
```
