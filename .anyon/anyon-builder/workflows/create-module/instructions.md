...
<critical>You MUST have already loaded and processed: {project-root}/.anyon/anyon-builder/workflows/create-module/workflow.yaml</critical>
<critical>Study existing modules in: {project-root}/.anyon/ for patterns</critical>
...
<check if="create">
  <action>Invoke module-brief workflow: {project-root}/.anyon/anyon-builder/workflows/module-brief/workflow.yaml</action>
...
2. **Module code** - Generate kebab-case from name following patterns:
   ...
   - Present suggested code and confirm it works for paths like .anyon/{{code}}/agents/
...
<critical>This is the STANDARD format that ANYON installer uses</critical>
...
# EXAMPLE Static path:
# data_path:
#   result: "{project-root}/.anyon/{{module_code}}/data"
...
The module can be configured in `.anyon/{{module_code}}/config.yaml`
