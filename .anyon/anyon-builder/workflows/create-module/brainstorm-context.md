...
_Context provided to brainstorming workflow when creating a new ANYON module_

## Session Focus

You are brainstorming ideas for a **complete ANYON module** - a self-contained package that extends the ANYON Method with specialized domain expertise and capabilities.

## What is a ANYON Module?
...
_This focused context helps create cohesive, valuable ANYON modules_
