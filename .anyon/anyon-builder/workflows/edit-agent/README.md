...
Interactive workflow for editing existing ANYON agents while maintaining best practices and modern standards.

## Purpose

This workflow helps you refine and improve existing agents by:

- Analyzing agents against ANYON best practices
...
- Update legacy agents to modern ANYON standards
...
- **All ANYON Method agents** - Examples of distinct, memorable communication voices
...
- **Use reference agents as guides** - Compare against commit-poet, journal-keeper, ANYON Method agents
...
Invoke via Anyon Builder agent:

```
/anyon:anyon-builder:agents:anyon-builder
...
This workflow ensures your agents meet the same high standards as the reference implementations and recently enhanced ANYON Method agents.
