...
<critical>You MUST have already loaded and processed: {project-root}/.anyon/anyon-builder/workflows/edit-agent/workflow.yaml</critical>
...
- ANYON Method agents (distinct voices): {anyon_method_agents}
...
- **Module** = Designed for ANYON ecosystem integration
...
Your agent meets all ANYON quality standards. Great work!"
</action>
</check>
