...
_Context provided to brainstorming workflow when creating a new ANYON workflow_

## Session Focus

You are brainstorming ideas for a **ANYON workflow** - a guided, multi-step process that helps users accomplish complex tasks with structure, consistency, and quality.

## What is a ANYON Workflow?
...
A great ANYON workflow should be:
...
_This focused context helps create valuable, structured ANYON workflows_
