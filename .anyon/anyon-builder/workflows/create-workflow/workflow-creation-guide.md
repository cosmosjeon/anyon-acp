# ANYON Workflow Creation Guide

Create structured, repeatable workflows for human-AI collaboration in ANYON v6.
...
installed_path: '{project-root}/.anyon/module/workflows/my-workflow'
...
<critical>The workflow execution engine is governed by: {project_root}/.anyon/core/tasks/workflow.xml</critical>
...
That's it! To execute, tell the ANYON agent: `workflow path/to/my-workflow/`
...
| **Location**   | `/src/core/tasks/` | `/.anyon/*/workflows/` |
...
# Paths
installed_path: '{project-root}/.anyon/module/workflows/name'
...
anyon-method/workflows/plan-project/workflow.yaml → standalone: true
anyon-method/workflows/architecture/workflow.yaml → standalone: true

# Helper workflows: standalone: false
anyon-method/workflows/internal/validate-epic/workflow.yaml → standalone: false
anyon-method/workflows/internal/format-story/workflow.yaml → standalone: false
```
...
**Intent-based workflows give the AI goals and principles, letting it adapt the conversation naturally to the user's context.** This is the ANYON v6 default for most workflows.
...
- Not part of ANYON workflow spec
...
- Full Load: `src/modules/anyon-method/workflows/2-plan-workflows/prd/`
- Selective Load: `src/modules/anyon-method/workflows/4-implementation/epic-tech-context/`
...
4. **Relative Paths**: Use `.anyon/` root paths (no `{project-root}`)
...
web_bundle:
  ...
  # Core files (.anyon/-relative paths)
  instructions: '.anyon/module/workflows/workflow/instructions.md'
  validation: '.anyon/module/workflows/workflow/checklist.md'
  template: '.anyon/module/workflows/workflow/template.md'

  # Data files (no config_source allowed)
  data_file: '.anyon/module/workflows/workflow/data.csv'

  # Complete file list - CRITICAL!
  web_bundle_files:
    - '.anyon/module/workflows/workflow/instructions.md'
    - '.anyon/module/workflows/workflow/checklist.md'
    - '.anyon/module/workflows/workflow/template.md'
    - '.anyon/module/workflows/workflow/data.csv'
...
1. **Remove Config Dependencies**:
   ...
   - Convert `{project-root}/.anyon/` to `.anyon/`
...
3. **Test Completeness**:
   ...
   - Verify all paths are relative to .anyon/
...
web_bundle:
  ...
  instructions: '.anyon/anyon-method/workflows/analyze-requirements/instructions.md'
  validation: '.anyon/anyon-method/workflows/analyze-requirements/checklist.md'
  template: '.anyon/anyon-method/workflows/analyze-requirements/template.md'

  # Data files
  techniques_data: '.anyon/anyon-method/workflows/analyze-requirements/techniques.csv'
  patterns_data: '.anyon/anyon-method/workflows/analyze-requirements/patterns.json'

  # Sub-workflow reference
  validation_workflow: '.anyon/anyon-method/workflows/validate-requirements/workflow.yaml'

  standalone: true

  web_bundle_files:
    # Core workflow files
    - '.anyon/anyon-method/workflows/analyze-requirements/instructions.md'
    - '.anyon/anyon-method/workflows/analyze-requirements/checklist.md'
    - '.anyon/anyon-method/workflows/analyze-requirements/template.md'

    # Data files
    - '.anyon/anyon-method/workflows/analyze-requirements/techniques.csv'
    - '.anyon/anyon-method/workflows/analyze-requirements/patterns.json'

    # Sub-workflow and its files
    - '.anyon/anyon-method/workflows/validate-requirements/workflow.yaml'
    - '.anyon/anyon-method/workflows/validate-requirements/instructions.md'
    - '.anyon/anyon-method/workflows/validate-requirements/checklist.md'

    # Shared templates referenced in instructions
    - '.anyon/anyon-method/templates/requirement-item.md'
    - '.anyon/anyon-method/templates/validation-criteria.md'
```
...
- `/.anyon/anyon-method/workflows/` - Production examples
