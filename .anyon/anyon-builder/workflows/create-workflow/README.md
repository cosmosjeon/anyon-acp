...
The Build Workflow is an interactive workflow builder that guides you through creating new ANYON workflows with proper structure, conventions, and validation. It ensures all workflows follow best practices for optimal human-AI collaboration and are fully compliant with the ANYON Core v6 workflow execution engine.
...
- **Convention Enforcement**: Ensures adherence to ANYON workflow creation guide
...
`{project-root}/.anyon/{{target_module}}/workflows/{{workflow_name}}/`
...
- ANYON Core v6 project structure
- Module to host the new workflow (anyon-method, anyon-builder, cis, or custom)
...
- **v6.0.0** - Initial ANYON Core v6 compatible version
...
- Review `/.anyon/anyon-builder/workflows/create-workflow/workflow-creation-guide.md`
- Check existing workflows in `/.anyon/anyon-method/workflows/` for examples
- Validate against `/.anyon/anyon-builder/workflows/create-workflow/checklist.md`
- Consult ANYON Method v6 documentation

---

_Part of the Anyon Method v6 - BMB (Anyon Builder) Module_
