...
<critical>You MUST have already loaded and processed: {project-root}/.anyon/anyon-builder/workflows/module-brief/workflow.yaml</critical>
...
- Other ANYON modules it might use
