# BMB - Anyon Builder Module

Specialized tools and workflows for creating, customizing, and extending Anyon components including agents, workflows, and complete modules.
...
**Anyon Builder** - Master builder agent orchestrating all creation workflows with deep knowledge of Anyon architecture and conventions.

### 📋 Workflows

Comprehensive suite for building and maintaining Anyon components.

## Core Workflows

### Creation Workflows

**[create-agent](./workflows/create-agent/README.md)** - Build Anyon agents
...
1. **Load Anyon Builder agent** in your IDE
...
- **Anyon Core** - Framework foundation
...
- **[BMM Module](../anyon-method/README.md)** - Reference implementation
- **[Core Framework](../../core/README.md)** - Foundation concepts

---

BMB empowers you to extend Anyon Method for your specific needs while maintaining framework consistency and power.
