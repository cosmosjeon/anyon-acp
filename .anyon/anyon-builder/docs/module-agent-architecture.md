...
```
.anyon/{module-code}/agents/{agent-name}.md
```
...
agent:
  metadata:
    id: '.anyon/{module-code}/agents/{agent-name}.md'
    name: 'Persona Name'
  ...
  menu:
    - trigger: workflow-action
      workflow: '{project-root}/.anyon/{module-code}/workflows/{workflow-name}/workflow.yaml'
      description: 'Execute module workflow'

    - trigger: another-workflow
      workflow: '{project-root}/.anyon/core/workflows/{workflow-name}/workflow.yaml'
      description: 'Execute core workflow'

    - trigger: task-action
      exec: '{project-root}/.anyon/{module-code}/tasks/{task-name}.xml'
      description: 'Execute module task'

    - trigger: cross-module
      workflow: '{project-root}/.anyon/other-module/workflows/{workflow-name}/workflow.yaml'
      description: 'Execute workflow from another module'

    - trigger: with-template
      exec: '{project-root}/.anyon/core/tasks/create-doc.xml'
      tmpl: '{project-root}/.anyon/{module-code}/templates/{template-name}.md'
      description: 'Create document from template'

    - trigger: with-data
      exec: '{project-root}/.anyon/{module-code}/tasks/{task-name}.xml'
      data: '{project-root}/.anyon/_cfg/agent-manifest.csv'
...
- **id**: Path with `.anyon` variable (resolved at install time)
- **name**: Agent persona name
- **title**: Professional role
- **icon**: Single emoji
- **module**: Module code (anyon-method, anyon-builder, cis, custom)
...
menu:
  - trigger: create-prd
    workflow: '{project-root}/.anyon/anyon-method/workflows/prd/workflow.yaml'
    description: 'Create Product Requirements Document'
```

Invokes ANYON workflow engine to execute multi-step processes.
...
menu:
  - trigger: validate
    exec: '{project-root}/.anyon/core/tasks/validate-workflow.xml'
...
menu:
  - trigger: create-brief
    exec: '{project-root}/.anyon/core/tasks/create-doc.xml'
    tmpl: '{project-root}/.anyon/anyon-method/templates/brief.md'
...
menu:
  - trigger: team-standup
    exec: '{project-root}/.anyon/anyon-method/tasks/standup.xml'
    data: '{project-root}/.anyon/_cfg/agent-manifest.csv'
...
menu:
  - trigger: advanced-elicitation
    exec: '{project-root}/.anyon/core/tasks/advanced-elicitation.xml'
    description: 'Advanced elicitation techniques'
    web-only: true # Only shows in web bundle

  - trigger: git-operations
    exec: '{project-root}/.anyon/anyon-method/tasks/git-flow.xml'
...
- `.anyon` - ANYON installation folder (usually `.anyon`)
...
# BAD
workflow: "/Users/john/project/.anyon/anyon-method/workflows/prd/workflow.yaml"

# BAD
workflow: "../../../anyon-method/workflows/prd/workflow.yaml"
```
...
```xml
<step n="2">Load and read {project-root}/.anyon/{module}/config.yaml...</step>
```

## Reference Examples

See: `src/modules/anyon-method/agents/`
...
menu:
  - trigger: init
    workflow: '{project-root}/.anyon/anyon-method/workflows/workflow-init/workflow.yaml'
    description: 'Initialize workflow path (START HERE)'

  - trigger: status
    workflow: '{project-root}/.anyon/anyon-method/workflows/workflow-status/workflow.yaml'
    description: 'Check current workflow status'

  - trigger: next-step
    workflow: '{project-root}/.anyon/anyon-method/workflows/next-step/workflow.yaml'
...
menu:
  # Phase 1: Analysis
  - trigger: brainstorm
    workflow: '{project-root}/.anyon/anyon-method/workflows/1-analysis/brainstorm/workflow.yaml'
    description: 'Guided brainstorming session'

  - trigger: research
    workflow: '{project-root}/.anyon/anyon-method/workflows/1-analysis/research/workflow.yaml'
    description: 'Market and technical research'

  # Phase 2: Planning
  - trigger: prd
    workflow: '{project-root}/.anyon/anyon-method/workflows/2-planning/prd/workflow.yaml'
    description: 'Create PRD'

  - trigger: architecture
    workflow: '{project-root}/.anyon/anyon-method/workflows/2-planning/architecture/workflow.yaml'
...
menu:
  - trigger: party-mode
    workflow: '{project-root}/.anyon/core/workflows/party-mode/workflow.yaml'
    description: 'Bring all agents together'

  - trigger: brainstorm
    workflow: '{project-root}/.anyon/cis/workflows/brainstorming/workflow.yaml'
    description: 'Use CIS brainstorming techniques'
```

## Best Practices

1. **Use .anyon paths** - Portable across installations
...
menu:
  - trigger: start
    workflow: '{project-root}/.anyon/{module}/workflows/init/workflow.yaml'
...
menu:
  - trigger: status
    workflow: '{project-root}/.anyon/{module}/workflows/status/workflow.yaml'
...
| ------------- | -------------------------------- | ------------------------------- |
| Location      | `.anyon/{module}/agents/` | `.anyon/custom/agents/`  |
...
- [ ] id uses `.anyon/{module}/agents/{name}.md`
- [ ] All workflow paths use `{project-root}/.anyon/` prefix
- [ ] No hardcoded paths
