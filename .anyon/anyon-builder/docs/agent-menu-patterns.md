...
# GOOD - Portable paths
workflow: "{project-root}/.anyon/anyon-method/workflows/prd/workflow.yaml"
exec: "{project-root}/.anyon/core/tasks/validate.xml"
...
- `.anyon` - ANYON installation folder
...
menu:
  - trigger: workflow-init
    workflow: '{project-root}/.anyon/anyon-method/workflows/workflow-status/init/workflow.yaml'
