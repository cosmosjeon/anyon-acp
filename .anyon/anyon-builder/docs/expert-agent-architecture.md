...
- Example: `.anyon/custom/agents/journal-keeper/`
...
See: `src/modules/anyon-builder/reference/agents/expert-examples/journal-keeper/`
...
cp -r /path/to/journal-keeper/ .anyon/custom/agents/
