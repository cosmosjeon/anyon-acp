...
- ✓ Use core variables (.anyon, {output_folder}, etc.)
...
agent:
  ...
  menu:
    - trigger: implement-story
      workflow: '.anyon/anyon-method/workflows/dev-story/workflow.yaml'
      description: Implement user story

    - trigger: refactor
      workflow: '.anyon/anyon-method/workflows/refactor/workflow.yaml'
...
- ✓ Coordinates with other ANYON Method agents
...
- A Simple agent COULD live in `.anyon/anyon-method/agents/`
...
- Lives in `.anyon/anyon-method/agents/formatter.agent.yaml`
...
- Lives in `.anyon/anyon-method/agents/tech-writer.agent.yaml`
- Orchestrates BMM documentation workflows
- Coordinates with other ANYON Method agents (PM, Dev, Analyst)
