...
Module agents integrate with ANYON module workflows (BMM, CIS, BMB). They:

- Orchestrate multi-step workflows
- Use `.anyon` path variables
...
See `/src/modules/anyon-builder/docs/module-agent-architecture.md` for complete guide.
