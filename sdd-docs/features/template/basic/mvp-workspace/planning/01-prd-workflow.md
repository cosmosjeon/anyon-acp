...
이 PRD를 바탕으로:
1. UX 디자인 (UI 있는 경우) - 화면 구성과 사용자 흐름 설계
...
PRD 완료 후:
1. **UI가 있는 프로젝트** → UX Design 워크플로우 진행
2. **UI가 없는 프로젝트** → Architecture 워크플로우로 이동
...
| 2025-12-28 | 다음 단계 조건부 표현 수정 - method-greenfield.yaml과 일치화 |
